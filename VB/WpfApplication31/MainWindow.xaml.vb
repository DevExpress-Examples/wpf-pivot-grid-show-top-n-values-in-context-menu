...
Namespace WpfApplication31
	...
	Partial Public Class MainWindow
		...
		Private Sub item_ItemClick(ByVal sender As Object, ByVal e As ItemClickEventArgs)
			...
			Dim sortConditions = valueItem.PivotGrid.GetFieldsByArea(If(valueItem.IsColumn, FieldArea.ColumnArea, FieldArea.RowArea)).Where(Function(f) f.AreaIndex <= valueItem.Field.AreaIndex).Select(Function(f) New With {
				Key .Field = f,
				Key .Value = valueItem.PivotGrid.GetFieldValue(f, valueItem.MaxLastLevelIndex)
			})
